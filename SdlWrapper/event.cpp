...
void sdl::EventHandler::on_quit(std::function<void(void)> const& fun){
...
void sdl::EventHandler::on_press(sdl::KeyCode code, std::function<void(void)> const& fun){
  actions_.insert(std::pair<KeyCode, std::function<void(void)>>(code, fun));
}